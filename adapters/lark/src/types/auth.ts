...
Internal.define({
  '/auth/v3/tenant_access_token/internal': {
    POST: { name: 'auth.auth.tenantAccessTokenInternal', type: 'raw-json' },
  },
  '/auth/v3/app_access_token/internal': {
    POST: { name: 'auth.auth.appAccessTokenInternal', type: 'raw-json' },
  },
  '/auth/v3/app_ticket/resend': {
    POST: 'auth.auth.appTicketResend',
  },
  '/auth/v3/app_access_token': {
    POST: { name: 'auth.auth.appAccessToken', type: 'raw-json' },
  },
  '/auth/v3/tenant_access_token': {
    POST: { name: 'auth.auth.tenantAccessToken', type: 'raw-json' },
  },
})
