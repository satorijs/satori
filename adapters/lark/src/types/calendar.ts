...
Internal.define({
  ...
  '/calendar/v4/calendars/{calendar_id}': {
    ...
    GET: 'calendar.calendar.get',
    PATCH: 'calendar.calendar.patch',
  },
  '/calendar/v4/calendars/primary': {
    POST: 'calendar.calendar.primary',
  },
  '/calendar/v4/freebusy/list': {
    POST: 'calendar.freebusy.list',
  },
  '/calendar/v4/calendars/search': {
    POST: { name: 'calendar.calendar.search', pagination: { argIndex: 1 } },
  },
  '/calendar/v4/calendars/{calendar_id}/subscribe': {
    POST: 'calendar.calendar.subscribe',
  },
  '/calendar/v4/calendars/{calendar_id}/unsubscribe': {
    POST: 'calendar.calendar.unsubscribe',
  },
  '/calendar/v4/calendars/subscription': {
    POST: 'calendar.calendar.subscription',
  },
  '/calendar/v4/calendars/unsubscription': {
    POST: 'calendar.calendar.unsubscription',
  },
  '/calendar/v4/calendars/{calendar_id}/acls': {
    POST: 'calendar.calendar.acl.create',
    GET: { name: 'calendar.calendar.acl.list', pagination: { argIndex: 1, itemsKey: 'acls' } },
  },
  '/calendar/v4/calendars/{calendar_id}/acls/{acl_id}': {
    DELETE: 'calendar.calendar.acl.delete',
  },
  '/calendar/v4/calendars/{calendar_id}/acls/subscription': {
    POST: 'calendar.calendar.acl.subscription',
  },
  '/calendar/v4/calendars/{calendar_id}/acls/unsubscription': {
    POST: 'calendar.calendar.acl.unsubscription',
  },
  '/calendar/v4/calendars/{calendar_id}/events': {
    POST: 'calendar.calendar.event.create',
    GET: 'calendar.calendar.event.list',
  },
  '/calendar/v4/calendars/{calendar_id}/events/{event_id}': {
    DELETE: 'calendar.calendar.event.delete',
    PATCH: 'calendar.calendar.event.patch',
    GET: 'calendar.calendar.event.get',
  },
  '/calendar/v4/calendars/{calendar_id}/events/search': {
    POST: { name: 'calendar.calendar.event.search', pagination: { argIndex: 2 } },
  },
  '/calendar/v4/calendars/{calendar_id}/events/subscription': {
    POST: 'calendar.calendar.event.subscription',
  },
  '/calendar/v4/calendars/{calendar_id}/events/unsubscription': {
    POST: 'calendar.calendar.event.unsubscription',
  },
  '/calendar/v4/calendars/{calendar_id}/events/{event_id}/reply': {
    POST: 'calendar.calendar.event.reply',
  },
  '/calendar/v4/calendars/{calendar_id}/events/{event_id}/instances': {
    GET: { name: 'calendar.calendar.event.instances', pagination: { argIndex: 2 } },
  },
  '/calendar/v4/calendars/{calendar_id}/events/instance_view': {
    GET: 'calendar.calendar.event.instanceView',
  },
  '/calendar/v4/calendars/{calendar_id}/events/{event_id}/meeting_chat': {
    POST: 'calendar.calendar.event.meetingChat.create',
    DELETE: 'calendar.calendar.event.meetingChat.delete',
  },
  '/calendar/v4/calendars/{calendar_id}/events/{event_id}/meeting_minute': {
    POST: 'calendar.calendar.event.meetingMinute.create',
  },
  ...
  '/calendar/v4/calendars/{calendar_id}/events/{event_id}/attendees': {
    POST: 'calendar.calendar.event.attendee.create',
    GET: { name: 'calendar.calendar.event.attendee.list', pagination: { argIndex: 2 } },
  },
  '/calendar/v4/calendars/{calendar_id}/events/{event_id}/attendees/batch_delete': {
    POST: 'calendar.calendar.event.attendee.batchDelete',
  },
  '/calendar/v4/calendars/{calendar_id}/events/{event_id}/attendees/{attendee_id}/chat_members': {
    GET: { name: 'calendar.calendar.event.attendee.chatMember.list', pagination: { argIndex: 3 } },
  },
