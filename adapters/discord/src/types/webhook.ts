...
declare module './internal' {
  interface Internal {
     ...
     */
    createWebhook(channel_id: snowflake, params: Webhook.Params.Create): Promise<Webhook>
    /**
     ...
     */
    modifyWebhook(webhook_id: snowflake, params: Webhook.Params.Modify): Promise<Webhook>
    /**
     ...
     */
    executeWebhook(webhook_id: snowflake, webhook_token: snowflake, params: Webhook.Params.Params): Promise<void>
    /**
     * Refer to Slack's documentation for more information. We do not support Slack's `channel`, `icon_emoji`, `mrkdwn`, or `mrkdwn_in` properties.
     * @see https://discord.com/developers/docs/resources/webhook#execute-slack-compatible-webhook
     */
    executeSlackCompatibleWebhook(webhook_id: snowflake, webhook_token: snowflake, params: Webhook.Params.Params): Promise<void>
    /**
     ...
     */
    executeGithubCompatibleWebhook(webhook_id: snowflake, webhook_token: snowflake, params: Webhook.Params.Params): Promise<void>
    /**
     * Returns a previously-sent webhook message from the same token. Returns a message object on success.
     * @see https://discord.com/developers/docs/resources/webhook#get-webhook-message
     */
    getWebhookMessage(webhook_id: snowflake, webhook_token: snowflake, message_id: snowflake, params: Webhook.Params.Params): Promise<PreviouslySentWebhookMessageFromTheSameToken.ReturnsAMessage>
    /**
     * Edits a previously-sent webhook message from the same token. Returns a message object on success.
     * @see https://discord.com/developers/docs/resources/webhook#edit-webhook-message
     */
    editWebhookMessage(webhook_id: snowflake, webhook_token: snowflake, message_id: snowflake, params: Webhook.Params.Modify): Promise<Message>
    /**
     * Deletes a message that was created by the webhook. Returns a `204 No Content` response on success.
     * @see https://discord.com/developers/docs/resources/webhook#delete-webhook-message
     */
    deleteWebhookMessage(webhook_id: snowflake, webhook_token: snowflake, message_id: snowflake, params: Webhook.Params.Params): Promise<void>
  }
}
