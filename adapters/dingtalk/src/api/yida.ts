...
export interface GetInstancesParams {
  ...
  /** 表单ID。 */
  formUuid: string;
  /** 查询过滤条件，支持2种模式的过滤规则。模式1：根据组件值模糊匹配，示例：{"textField_jcr0069m":"danhang","selectField_jcr0069q":"K"}  模式2: 采用数据管理的查询过滤条件，匹配功能更强大，示例：[{"key":"currentNodeName","value":"步凡","type":"TEXT","operator":"like","componentName":"TextField”}]，详情参考 */
  searchFieldJson?: string;
  /** 根据流程发起人工号查询。 */
  originatorId?: string;
  /** 创建时间起始值。 */
