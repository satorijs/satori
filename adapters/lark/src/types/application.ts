...
Internal.define({
  '/application/v6/applications/{app_id}/owner': {
    PUT: 'application.application.owner.update',
  },
  '/application/v6/applications/{app_id}/collaborators': {
    PUT: 'application.application.collaborators.update',
    GET: 'application.application.collaborators.get',
  },
  '/application/v6/applications/{app_id}': {
    GET: 'application.application.get',
    PATCH: 'application.application.patch',
  },
  '/application/v6/applications/{app_id}/app_versions/{version_id}': {
    GET: 'application.application.appVersion.get',
    PATCH: 'application.application.appVersion.patch',
  },
  '/application/v6/applications/{app_id}/app_versions': {
    GET: { name: 'application.application.appVersion.list', pagination: { argIndex: 1 } },
  },
  '/application/v6/applications/{app_id}/app_versions/{version_id}/contacts_range_suggest': {
    GET: 'application.application.appVersion.contactsRangeSuggest',
  },
  ...
  '/application/v6/applications': {
    GET: { name: 'application.application.list', pagination: { argIndex: 0, itemsKey: 'app_list' } },
  },
  '/application/v6/applications/underauditlist': {
    GET: { name: 'application.application.underauditlist', pagination: { argIndex: 0 } },
  },
  '/application/v6/applications/{app_id}/contacts_range_configuration': {
    GET: 'application.application.contactsRangeConfiguration',
  },
  '/application/v6/applications/{app_id}/contacts_range': {
    PATCH: 'application.application.contactsRange.patch',
  },
  '/application/v6/applications/{app_id}/visibility/check_white_black_list': {
    POST: 'application.application.visibility.checkWhiteBlackList',
  },
  '/application/v6/applications/{app_id}/visibility': {
    PATCH: 'application.application.visibility.patch',
  },
  '/application/v6/applications/{app_id}/management': {
    PUT: 'application.application.management.update',
  },
  '/application/v6/applications/{app_id}/app_usage/department_overview': {
    POST: 'application.application.appUsage.departmentOverview',
  },
  '/application/v6/applications/{app_id}/app_usage/message_push_overview': {
    POST: 'application.application.appUsage.messagePushOverview',
  },
  '/application/v6/applications/{app_id}/app_usage/overview': {
    POST: 'application.application.appUsage.overview',
  },
  '/application/v6/applications/{app_id}/feedbacks/{feedback_id}': {
    PATCH: 'application.application.feedback.patch',
  },
  '/application/v6/applications/{app_id}/feedbacks': {
    GET: { name: 'application.application.feedback.list', pagination: { argIndex: 1, itemsKey: 'feedback_list' } },
  },
  '/application/v6/app_badge/set': {
    POST: 'application.appBadge.set',
  },
  '/application/v5/applications/favourite': {
    GET: { name: 'application.application.favourite', pagination: { argIndex: 0, itemsKey: 'app_list' } },
  },
  '/application/v5/applications/recommend': {
    GET: { name: 'application.application.recommend', pagination: { argIndex: 0, itemsKey: 'app_list' } },
  },
